...
> **Scope superseded (2026-09-25).** The FightCade launcher path described here was removed and the
> app is being re-scoped into a general multi-game session coordinator. See
> [`design-general-emulation.md`](design-general-emulation.md) for the agreed design and
> [`12-fightcade-ripout.md`](12-fightcade-ripout.md) for the removal. This file is retained as the
> FightCade-era spec and history.
