...
- `src-tauri/` — Rust backend (`config`, `tailscale`, `roms`, `launcher`, `contracts`, `providers/{fightcade,retroarch/{core,hotkeys,parity,spec,command}}`, `session`, `windowing`, `commands`).
